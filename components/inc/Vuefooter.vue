                    ...
                    <div class="col-md-3 tablets-clear col-xs-12">
                        <ul>
                            <li id="anps_menu-4" class="widget-container anps_menu_widget">
                                ...
                                <ul id="menu-footer-menu-3" class="menu menu-1-column">
                                    <li id="menu-item-1612" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1612"><a href="#">Short trucks</a></li>
                                    <li id="menu-item-1613" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1613"><a href="#">Main load truck</a></li>
                                    <li id="menu-item-1614" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1614"><a href="#">Main truck</a></li>
                                    <li id="menu-item-1615" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1615"><a href="#">Big trailer truck</a></li>
                                    <li id="menu-item-1616" class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-1616"><a href="#">Van delivery</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
