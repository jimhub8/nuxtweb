<template>
<div class="container">
    <div class="vc_row wpb_row vc_row-fluid vc_custom_1515053148951">
        <div class="wpb_column vc_column_container vc_col-sm-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <h5 style="color: #f4b757;text-align: center" class="vc_custom_heading vc_custom_1515145466419">Our Services</h5>
                    <h3 style="text-align: center" class="vc_custom_heading vc_custom_1515076884742">The complete <b>solution</b></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="vc_row wpb_row vc_row-fluid vc_custom_1515053087915">
        <div class="wpb_column vc_column_container vc_col-sm-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="container">
                        <div class="row owly">
                            ...
                            <div class="col-xs-6 col-md-6 align-right"><a class="owlprev" style="background:#ffffff;"><i class="fa fa-chevron-left" style="color:#000000;"></i></a><a class="owlnext" style="background:#ffffff;"><i class="fa fa-chevron-right" style="color:#000000;"></i></a></div>
                        </div>
                    </div>
                    <ul class="owl-carousel recentportfolio clearfix owl-loaded owl-drag" data-col="3">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(-1370px, 0px, 0px); transition: all 0s ease 0s; width: 5481px;">
                                <div class="owl-item cloned" style="width: 426.667px; margin-right: 30px;">
                                    <li class="item item-type-line">
                                        <div class="mask"></div>
                                        <div class="item-info">
                                            <div class="headline">
